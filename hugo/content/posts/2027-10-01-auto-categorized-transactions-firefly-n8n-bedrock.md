...
description: >-
  ...
  (regex + Claude on Bedrock) labels every row, cross-source dedup keeps the
  books clean, and the dashboard is fresh within seconds of every swipe.
tags:
  - Firefly
  - n8n
  - Bedrock
...
- **ntfy** — `binwiederhier/ntfy`, behind Traefik. Reverse-proxied with a Cloudflare cert; the iOS app and a [systemd ntfy client](/blog/2027/03/01/ntfy-desktop-notifications-linux.html) on the laptop subscribe to the topics.
