...
However, a developer must keep in mind that there are some things which can severely limit the scalability of the Node.js application. I have earlier already covered [How DNS resolution is a blocking call in node and must be handled to achieve scalability](/blog/2016/05/28/nodejs-dns-cache.html)
